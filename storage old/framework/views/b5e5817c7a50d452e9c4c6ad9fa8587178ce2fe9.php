...
<script>
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "Detaylı alıntı yazın.....",
          tabsize: 2,
          height: 100
      });
    });
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Ecommerce-Laravel\Ecommerce-Laravel\resources\views/backend/post/create.blade.php ENDPATH**/ ?>