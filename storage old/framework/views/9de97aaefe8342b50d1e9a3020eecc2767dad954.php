                        ...
                        <ul class="list-main">
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(Auth::user()->role == 'admin'): ?>
                                    <li><i class="fa fa-truck"></i> <a href="<?php echo e(route('order.track')); ?>">Sipariş Takibi</a>
                                    </li>
                                    <li><i class="ti-user"></i> <a href="<?php echo e(route('admin')); ?>" target="_blank">Yönetim
                                            Paneli</a></li>
                                <?php else: ?>
                                    <li><i class="fa fa-truck"></i> <a href="<?php echo e(route('order.track')); ?>">Sipariş Takibi</a>
                                    </li>
                                    <li><i class="ti-user"></i> <a href="<?php echo e(route('user')); ?>" target="_blank">Hesabım</a>
                                    </li>
                                <?php endif; ?>
                                <li><i class="ti-power-off"></i> <a href="<?php echo e(route('user.logout')); ?>">Çıkış Yap</a></li>
                            <?php else: ?>
                                <li><i class="fa fa-sign-in"></i><a href="<?php echo e(route('login.form')); ?>">Giriş Yap /</a> <a
                                        href="<?php echo e(route('register.form')); ?>">Kayıt Ol</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <!-- End Top Right -->
                    ...
                    <div class="right-bar">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span><?php echo e(count(Helper::getAllProductFromWishlist())); ?> Ürün</span>
                                        <a href="<?php echo e(route('wishlist')); ?>">Favori Listesini Gör</a>
                                    </div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="<?php echo e(route('cart')); ?>" class="btn animate">Sepet</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <!--/ End Shopping Item -->
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            <?php if(auth()->guard()->check()): ?>
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span><?php echo e(count(Helper::getAllProductFromCart())); ?> Ürün</span>
                                        <a href="<?php echo e(route('cart')); ?>">Sepeti Görüntüle</a>
                                    </div>
                                    <ul class="shopping-list">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="<?php echo e(route('checkout')); ?>" class="btn animate">Ödemeye Geç</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <!--/ End Shopping Item -->
                                    ...
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="<?php echo e(Request::path() == 'contact' ? 'active' : ''); ?>"><a
                                                    href="<?php echo e(route('contact')); ?>">İletişim</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
...
<?php /**PATH C:\wamp64\www\Ecommerce-Laravel\Ecommerce-Laravel\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>