            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-12">
                    ...
                    <div class="single-footer links">
                        <h4>Bilgiler</h4>
                        <ul>
                            <li><a href="<?php echo e(route('about-us')); ?>">Hakkımızda</a></li>
            ...
            <div class="inner">
                <div class="row center-footer-logo">
                    <div class="col-lg-6 col-12">
                        <div class="left">
                            <p>© <?php echo e(date('Y')); ?> Developed By Yaman Sankari - All Rights Reserved.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="right">
                            <img class="university-logo" src="<?php echo e(asset('frontend/img/university.webp')); ?>"
                                alt="#">
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\wamp64\www\Ecommerce-Laravel\Ecommerce-Laravel\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>