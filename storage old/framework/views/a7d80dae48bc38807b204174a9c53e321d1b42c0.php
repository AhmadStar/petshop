                    ...
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            <div class="title">
                                ...
                                ?>
                                <h4>İletişim</h4>
                            <h3>Bize mesaj yazın <?php if(auth()->guard()->check()): ?> <?php else: ?><span style="font-size:12px;" class="text-danger">[Önce
                                    giriş yapmalısınız]</span><?php endif; ?>
                            </h3>
                        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Ecommerce-Laravel\Ecommerce-Laravel\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>