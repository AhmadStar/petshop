      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>&copy; <?php echo e(date('Y')); ?> Developed By Yaman Sankari.</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<?php /**PATH C:\wamp64\www\Ecommerce-Laravel\Ecommerce-Laravel\resources\views/backend/layouts/footer.blade.php ENDPATH**/ ?>