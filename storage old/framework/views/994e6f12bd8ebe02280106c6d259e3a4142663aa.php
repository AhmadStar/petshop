    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('category.store')); ?>">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Başlık girin"  value="<?php echo e(old('title')); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_parent' id='is_parent' value='1' checked> Evet
        </div>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Ecommerce-Laravel\Ecommerce-Laravel\resources\views/backend/category/create.blade.php ENDPATH**/ ?>