...
<div class="card">
    <h5 class="card-header">Banner Düzenle</h5>
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <input id="inputTitle" type="text" name="title" placeholder="başlık girin"  value="{{$banner->title}}" class="form-control">
        @error('title')
        ...
        <div class="form-group">
          <label for="inputDesc" class="col-form-label">Açıklama</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($banner->status=='inactive') ? 'selected' : '')}}>Inaktif</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
