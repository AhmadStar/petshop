...
<div class="card">
    <h5 class="card-header">Gönderiyi Düzenle</h5>
    <div class="card-body">
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">Kısa Açıklama <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Açıklama <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="address" class="col-form-label">Adres <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="phone" class="col-form-label">Telefon Numarası <span class="text-danger">*</span></label>
